...
router.get("/porEstudiante/:id", inscripcionController_1.listarInscripcionesPorEstudiante);
router.get("/porCurso/:id", inscripcionController_1.listarInscripcionesPorCurso);
...
router.get('/:curso_id/:estudiante_id/modificar', inscripcionController_1.modificarInscripcion); // Ruta para mostrar el formulario de modificación
